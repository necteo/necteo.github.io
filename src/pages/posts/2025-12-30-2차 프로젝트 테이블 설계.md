...
CREATE TABLE product_item (
    ...
    base_item_id    NUMBER, -- null은 base 그 외 option
    add_price   NUMBER DEFAULT 0, -- 추가금액
    regdate     DATE DEFAULT SYSDATE,
    moddate     DATE,
    ...
    CONSTRAINT pi_bid_fk FOREIGN KEY(base_item_id) REFERENCES product_item(item_id),    -- 자기 참조
